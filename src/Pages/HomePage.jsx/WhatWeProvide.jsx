...
import img_1 from "../../../public/About-us/02_about.jpg";

const WhatWeProvide = () => {
  return (
    <div className="bg-[#F9F9F9] py-16 px-4 mt-72 sm:mt-40 md:mt-20">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-12 lg:gap-28">
        ...
        <div className="relative w-full h-[280px] sm:h-[320px] md:h-[360px] lg:h-[400px]">
          <img
            src={img_1}
            alt="About Us"
            className="w-full h-[300px] object-cover absolute top-0 left-0 z-20 rounded-md shadow-md"
          />
          ...
          <div className="w-full h-[300px] bg-blue-500 absolute top-12 left-8 sm:left-10 z-0 rounded-md"></div>
        </div>
      </div>
    </div>
  );
